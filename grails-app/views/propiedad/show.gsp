            ...
            <g:form resource="${this.propiedad}" method="DELETE">
                <fieldset class="buttons">
                  <g:if test="${session!=null && session.usuario!=null}">
                    ...
                    <g:else>
                     <li><g:link class="create" controller="propiedad" action="agregarComentario" params="[idpropiedad:this.propiedad.id]"><span class="glyphicon glyphicon-log-in"></span>Obtener mas informacion</g:link></li>
                    </g:else>
                </fieldset>
            </g:form>
        </div>
